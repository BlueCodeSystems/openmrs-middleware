...
const CONTROLLERS = [
    ...
    controllerGenerator('person/attribute')(daoGenerator('person_attribute','uuid',['date_created','date_changed'],connection)),
    controllerGenerator('person/attribute/type')(daoGenerator('person_attribute_type','uuid',['date_created','date_changed'],connection)),
    ...
    controllerGenerator('visit')(daoGenerator('visit','uuid',['date_created','date_changed'],connection)),
